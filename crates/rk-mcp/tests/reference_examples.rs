...
fn variant_name(cmd: &Command) -> &'static str {
    match cmd {
        ...
        Command::RenameSketch { .. } => "rename_sketch",
        ...
        Command::RenameFeature { .. } => "rename_feature",
        Command::SetFeatureSuppressed { .. } => "set_feature_suppressed",
        Command::GroupFeatures { .. } => "group_features",
        Command::UngroupFeatures { .. } => "ungroup_features",
        Command::RenameFeatureGroup { .. } => "rename_feature_group",
        Command::SetFeatureGroupCollapsed { .. } => "set_feature_group_collapsed",
